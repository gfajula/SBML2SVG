/****************************************************************************
 **
 ** This file is part of yFiles-2.5.0.4. 
 ** 
...
public class LayoutPreviewPanel extends JComponent
{
  ...
  protected void paint(Graphics2D g, LayoutGraph lg, Edge e){
    ...
    for (int i = 0; i < el.pointCount(); i++){
      YPoint next = (YPoint) el.getPoint(i);
      line.x1 = lastX;
      line.y1 = lastY;
      line.x2 = next.x;
      line.y2 = next.y;
  ...
  protected void paint(Graphics2D g, LayoutGraph graph, Node node){      
    ...
    TextLayout tl = new TextLayout("" + node.index(),g.getFont(), g.getFontRenderContext()); 
   ...
   */
  public void setGraph(y.layout.LayoutGraph graph)
  {
    this.graph = graph;
  }
   ...
   */
  public y.layout.Layouter getLayouter()
  {
    return layouter;
  }
   ...
   * when invoking update().
   */
  public void setLayouter(y.layout.Layouter layouter)
  {
    this.layouter = layouter;
  }
