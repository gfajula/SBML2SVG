...
public class MSimpleMolecule extends MSpeciesSimple{

	public MSimpleMolecule(String id, String name, String compartment ) {
		super( id , id, 
			   name,  compartment , 1, 
			   "inactive",  
	...
	public MSimpleMolecule(String idAlias, String id, String name, String compartment, int homodimer,
