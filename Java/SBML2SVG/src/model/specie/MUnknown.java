...
public class MUnknown extends MSpeciesSimple{
	
	public MUnknown(String id, String name, String compartment ) {
		super( id , id, 
			   name,  compartment , 1, 
			   "inactive",  
...
//		this.structuralState = null;
	...
	public MUnknown(String idAlias, String id, String name, String compartment, int homodimer,
