...
import svgview.shapes.SVGInhibitionTip;
import svgview.shapes.SVGShape;
import svgview.species.SVGSpecie;
import svgview.util.SVGUtil;

public class SVGInhibition extends SVGGenericReaction {

	public SVGInhibition(Document svgDoc, MReaction mr, Map<String, SVGSpecie> species){
	...
	protected SVGShape getArrow(Point2D porig, Point2D pdest, boolean reversible) {
		...
		return new SVGInhibitionTip(porig, pdest, reversible, 
