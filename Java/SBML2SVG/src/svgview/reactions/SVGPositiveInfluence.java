...
import svgview.shapes.SVGPositiveInfluenceTip;
import svgview.shapes.SVGShape;
import svgview.species.SVGSpecie;
import svgview.util.SVGUtil;

public class SVGPositiveInfluence extends SVGInhibition {
	public SVGPositiveInfluence(Document svgDoc, MReaction mr, Map<String, SVGSpecie> species){
	...
	protected SVGShape getArrow(Point2D porig, Point2D pdest, boolean reversible) {
		...
		return new SVGPositiveInfluenceTip(porig, pdest, reversible, 
